...
const PolishIndex: React.FC = () => {
    ...
    return (
        <div className="p-8 space-y-10 font-mono bg-black min-h-screen">
            {/* Header */}
            <div>
                <h1 className="text-3xl font-black text-white flex items-center gap-4 uppercase tracking-[0.2em]">
                    <Sparkles className="text-[#00ff88] gpsx-glow" size={32} />
                    Refinement_Core
                </h1>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="text-[#00ff88] hover:text-white text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-colors group"
                    >
                ...
                {loading ? (
                    <div className="bg-[#050505] border border-white/5 p-20 text-center flex flex-col items-center gap-4">
                        ...
                        <p className="text-[#00ff88] text-[10px] font-black uppercase tracking-[0.3em]">Synching_Nodes...</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {recentProjects.map((project) => (
                            <div
                                ...
                                className="bg-[#050505] border border-white/5 p-6 hover:border-[#00ff88]/40 transition-all cursor-pointer group relative overflow-hidden"
                            >
                                <div className="gpsx-scanline opacity-5 pointer-events-none"></div>

                                <div className="flex items-start gap-4 mb-6">
                                    <div className="w-12 h-12 border border-white/5 flex items-center justify-center text-slate-600 group-hover:border-[#00ff88]/30 group-hover:text-[#00ff88] transition-all">
                                        <FileText size={20} />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-white text-xs font-black uppercase tracking-widest truncate group-hover:text-[#00ff88] transition-colors">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                    ...
                                    <span className="text-[9px] text-slate-600 font-black uppercase group-hover:text-[#00ff88] transition-colors tracking-widest flex items-center gap-2">
                                        INITIATE_REFINEMENT &gt;
                                    </span>
                                </div>
                            </div>
